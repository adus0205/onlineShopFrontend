...
export class LoginComponent implements OnInit {
        ...
        .subscribe({
          ...
          error: err => {
            ...
            if(err.error.message){
              ...
              this.registerErrorMessage = "Coś poszło nie tak, spróbuj ponownie";
            }
          }
      });
    }
  ...
  private isPasswordIdentical(regiser: any): boolean{
    if(regiser.password === regiser.repeatPassword){
